...
ggplot(nuuk21_04_dmi_temp_smoothed_15yr |> filter(annual < 10, annual > -10),
  aes(x = year, y = annual)) +
  # raw points + linear trend (historic)
  geom_point(data = nuuk_21_04_dmi_temp, aes(x = year, y = annual, color = "DMI 21_04"), size = 3, alpha = 0.6, color = "darkgreen") +
  geom_smooth(method = "lm", se = FALSE, color = "darkgreen") +

  # 5-year rolling mean (historic)
  geom_line(aes(y = seg_mean_temp), color = "black", size = 1.1) +

  # second dataset: note the data= and aes(x=Year, y=mean_temp)
  geom_point(data = nuuk25_08,
             aes(x = Year, y = mean_temp),
             size = 3, alpha = 0.6, color = "red", color = "DMI 25_08") +
  geom_smooth(data = nuuk25_08,
              aes(x = Year, y = mean_temp),
              method = "lm", se = FALSE, color = "red") +
    geom_point(data = data_temp_annual_mean,
             aes(x = year, y = mean),
             size = 3, alpha = 0.6, color = "blue", color = "GEM data") +
