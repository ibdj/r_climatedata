...
library(pacman)
pacman::p_load(ggplot2, tidyverse, janitor, lubridate, glue, hms,knitr, broom, ggpmisc, yaml,readxl)
...
##Absolute numers of variation in degree days
...
gr_monthly_all_1784_2020 <- read_delim("~/Library/CloudStorage/OneDrive-Aarhusuniversitet/MappingPlants/01 Vegetation changes Kobbefjord/data/r_climatedata/data/dmi_historic/DMIRep21-04/gr_monthly_all_1784_2020.csv", delim = ";", escape_double = FALSE, trim_ws = TRUE)

nuuk_dmi_temp <- gr_monthly_all_1784_2020 |>
  filter(stat_no == 4250, annual != "null")
...
```{r}
{r}
#| label: fig-annual-temp-historis
