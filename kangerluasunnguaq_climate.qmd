...
library(pacman)
pacman::p_load(ggplot2, tidyverse, janitor, lubridate, glue, hms,knitr, broom, ggpmisc, yaml,readxl,zoo,emmeans,lme4,multcomp,Hmisc)
...
data_par_below_200 <- below_200 |> 
  ...
  summarize(below_200 = n())

# Step 4: Plot
ggplot(data_par_below_200, aes(x = year, y = below_200)) +
  geom_point(size = 3, alpha = 0.7, color = "#076834") +
...
# Fit the model
model_above <- lm(below_200 ~ year, data = below_200)
