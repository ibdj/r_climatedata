...
library(pacman)
pacman::p_load(ggplot2, Hmisc, tidyverse, janitor, lubridate, glue, hms,knitr, broom, ggpmisc, yaml,readxl,zoo,emmeans,lme4,multcomp, vegan,lmerTes, codyn, patchwork,tibble)
...
p <- ggplot() +
  ...
  geom_point(data = emm_year,
             aes(x = year, y = est),
             colour = "black",        # a strong orange for visibility
             size   = 3) +
